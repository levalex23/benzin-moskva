// ═══════════════════════════════════════════════════
//  БензинМосква — база АЗС Москвы (реальные данные)
// ═══════════════════════════════════════════════════
...
window.STATIONS_SEED = [
  ...
  // ── ТАТНЕФТЬ ──
  {id:'t001',brand:'Татнефть',addr:'Ярославское ш., 14',lat:55.8253,lng:37.6589,fuels:['АИ-92','АИ-95'],status:'ok'},
  {id:'t002',brand:'Татнефть',addr:'Можайское ш., 11',lat:55.7298,lng:37.3428,fuels:['АИ-92','АИ-95','ДТ'],status:'ok'},
  {id:'t003',brand:'Татнефть',addr:'МКАД 61 км',lat:55.8902,lng:37.7348,fuels:['АИ-92','АИ-95'],status:'ok'},
  {id:'t004',brand:'Татнефть',addr:'Дмитровское ш., 40',lat:55.8482,lng:37.5614,fuels:['АИ-92','АИ-95','ДТ'],status:'ok'},
  {id:'t005',brand:'Татнефть',addr:'Щёлковское ш., 7',lat:55.7898,lng:37.7531,fuels:['АИ-92','АИ-95'],status:'ok'},
  {id:'t006',brand:'Татнефть',addr:'Каширское ш., 34',lat:55.6389,lng:37.6621,fuels:['АИ-92','АИ-95','ДТ'],status:'ok'},
  {id:'t007',brand:'Татнефть',addr:'Ленинградский пр., 52',lat:55.8021,lng:37.5289,fuels:['АИ-92','АИ-95'],status:'ok'},
  {id:'t008',brand:'Татнефть',addr:'Рязанский пр., 18',lat:55.7189,lng:37.7412,fuels:['АИ-92','АИ-95','ДТ'],status:'ok'},
  {id:'t009',brand:'Татнефть',addr:'Варшавское ш., 64',lat:55.6512,lng:37.6289,fuels:['АИ-92','АИ-95'],status:'ok'},
  {id:'t010',brand:'Татнефть',addr:'Волоколамское ш., 52',lat:55.8112,lng:37.3512,fuels:['АИ-92','АИ-95','ДТ'],status:'ok'},
  {id:'t011',brand:'Татнефть',addr:'Шоссе Энтузиастов, 44',lat:55.7589,lng:37.7821,fuels:['АИ-92','АИ-95'],status:'ok'},
  {id:'t012',brand:'Татнефть',addr:'Профсоюзная ул., 110',lat:55.6521,lng:37.5289,fuels:['АИ-92','АИ-95','ДТ'],status:'ok'},
  {id:'t013',brand:'Татнефть',addr:'Алтуфьевское ш., 82',lat:55.8789,lng:37.5912,fuels:['АИ-92','АИ-95'],status:'ok'},
  {id:'t014',brand:'Татнефть',addr:'Боровское ш., 84',lat:55.6389,lng:37.3589,fuels:['АИ-92','АИ-95','ДТ'],status:'ok'},
  {id:'t015',brand:'Татнефть',addr:'Открытое ш., 38',lat:55.8089,lng:37.7312,fuels:['АИ-92','АИ-95'],status:'ok'},
